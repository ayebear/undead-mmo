You MUST copy these project files to the root directory of the local clone of the git repository! Otherwise your IDE will NOT be able to find any libraries or source code files.
